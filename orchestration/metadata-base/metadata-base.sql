CREATE TABLE IF NOT EXISTS etl_dag (
...
CREATE TABLE IF NOT EXISTS etl_dependency (
    id SERIAL PRIMARY KEY,
    dag_id VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS etl_trigger_queue (
   id SERIAL PRIMARY KEY,
